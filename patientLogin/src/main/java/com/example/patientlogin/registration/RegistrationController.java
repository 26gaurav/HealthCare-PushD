...
//    }
    ...
    @PostMapping(path = "register/{doc_id}")
    public AppUser register(@RequestBody RegistrationRequest request, @PathVariable Long doc_id)
            throws MessagingException, UnsupportedEncodingException
    {

        Doctor doctor = doctorDB.getDoctor(doc_id);
